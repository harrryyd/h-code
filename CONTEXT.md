...
- "PR review" and "review panel" were used loosely — resolved: use **Change Request Review** as the canonical domain term, **Review Draft** for the locally cached comment set, and **Background Review Agent** for the AI spawned to respond to comments. "PR review" is acceptable in conversation since it maps to the common GitHub use case.
